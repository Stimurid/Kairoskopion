...
class TestFieldPositionModelDataclass(unittest.TestCase):
    def test_create_article_fpm(self):
        fpm = FieldPositionModel(
            ...
            framework_affiliation_vector={"Simondon": 0.9, "Stiegler": 0.3},
        )
    ...
    def test_create_venue_fpm(self):
        fpm = FieldPositionModel(
            ...
            framework_affiliation_vector={"continental_phenomenology": 0.6},
            framework_envelope={"continental_phenomenology": [0.2, 0.9]},
        )
...
class TestComputeFieldPositionFit(unittest.TestCase):
    def _make_article(self):
        return {
            "discipline_vector": {"philosophy_of_technology": 0.7, "STS": 0.3},
            "framework_affiliation_vector": {"Simondon": 0.8, "Stiegler": 0.2},
    ...
    def _make_venue_good_fit(self):
        return {
            ...
            "framework_affiliation_vector": {"Simondon": 0.5, "continental_phenomenology": 0.3},
            "framework_envelope": {
                "Simondon": [0.2, 0.9],
                "Stiegler": [0.0, 0.5],
    ...
    def test_poor_fit(self):
        ...
        venue["framework_envelope"] = {"Chicago_school": [0.5, 1.0]}
...
class TestPromptFamilyValidators(unittest.TestCase):
    def test_valid_article_fpm(self):
        parsed = {
            ...
            "framework_affiliation_vector": {"x": 0.6, "y": 0.4},
    ...
    def test_missing_vector(self):
        parsed = {
            "discipline_vector": {},
            "framework_affiliation_vector": {"x": 0.5, "y": 0.5},
            "argument_move_vector": {"p": 0.5, "q": 0.5},
    ...
    def test_valid_venue_fpm(self):
        parsed = {
            ...
            "framework_affiliation_vector": {"x": 0.5},
            "framework_envelope": {"x": [0.1, 0.9]},
