...
def _build_from_llm(
    ...
    return ArticleSemanticProfile(
        ...
        schools_and_traditions=parsed.get("framework_affiliations") or parsed.get("schools_and_traditions", []),
        theoretical_shoulders=parsed.get("foundational_anchors") or parsed.get("theoretical_shoulders", []),
