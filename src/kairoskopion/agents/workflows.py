...
UC1_DRAFT_TO_VENUE_POOL_POSITIONING = AgenticWorkflowSpec(
    ...
    description=(
        ...
        "fit screening → mismatch/rewrite/citation/reference verification → "
        "risk → evidence audit"
    ),
    implementation_status="executable",
    steps=[
        ...
        _step(8, "reference_verifier",
              output_key="reference_verification",
              input_keys=["article", "bibliography_profile"],
              description="Verify references: DOI resolution, padding risk, integrity checks"),
        _step(9, "risk_officer",
              output_key="risk_report",
        ...
        _step(10, "compliance_auditor",
               output_key="compliance",
               input_keys=["article", "venue"],
               skip_if_missing=["venue"],
               description="Compliance check"),
        _step(11, "submission_pack_builder",
