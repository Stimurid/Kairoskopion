...
UC1_DRAFT_TO_VENUE_POOL_POSITIONING = AgenticWorkflowSpec(
    ...
    steps=[
        ...
        _step(3, "venue_discovery",
              ...
              input_keys=["pathways"],
              description="Discover candidate venues from seed corpus"),
        _step(4, "fit_assessor",
              output_key="fit_assessment",
              input_keys=["article", "venue"],
              skip_if_missing=["venue"],
              description="Assess fit (requires venue selection)"),
        ...
        _step(10, "submission_pack_builder",
               ...
               input_keys=["article", "venue", "fit_assessment", "mismatch_map",
                           "rewrite_plan", "risk_report", "compliance"],
...
VENUE_DEEP_PROFILE = AgenticWorkflowSpec(
    ...
    description="Enrich a venue: profiler + regime classifier + publication profile builder",
    implementation_status="executable",
    steps=[
        ...
        _step(1, "publication_regime_classifier",
              output_key="publication_regime",
              input_keys=["venue"],
              description="Classify publication regime"),
        _step(2, "venue_publication_profile_builder",
              output_key="venue_publication_profile",
              input_keys=["venue"],
              description="Build full publication profile"),
    ],
)
