...
VENUES: list[VenueDef] = [
    ...
    VenueDef(
        ...
        claims=[
            ...
            fact("homepage", "current_issue_full_toc",
                 {"issue": "Vol 13 No 2 (2025): Modes of Futurity: Prophecies, Utopias, Dystopias",
                  "published": "2025-12-28",
                  "sections": {
                      "From the Editor": ["Prophecy, Utopia, Apocalypse: On the Eve of the Russo-Ukrainian War"],
                      "Thematic Articles": [
                          "Michael Marder — Prophecy and/against Populism in the Hebrew Bible",
                          "Vladislav Makarov — Re(per)version of Resurrection: Literary Deconstruction of Russian Cosmism (RU)"],
                      "Essay": [
                          "Alexander Etkind — Soothsaying from Texts: What Selective Readings from the Recent Past Teach Us About the Nearest Future"],
                      "Other Articles": [
                          "Stepan Mezhuev — Vladimir Bibler's Paradoxical Post-Marxism, or the Cultural Logic of Late Socialism"],
                      "Discussions": [
                          "Mark Lipovetsky — Будущее Пелевина (RU)",
                          "Ilya Kukulin — Дематериализация горящей нефтебазы (response to Lipovetsky)",
                          "Anton Syutkin (Stasis Centre faculty) — Шеллинг и материалистическая теодицея",
                          "Kirill Chepurin — Только иногда, или Когда мира нет"],
                      "Reviews": [
                          "Samson Liberman — Назад в будущее: о возвращении утопического на примере «Пост-Европы» Юка Хуэя ⭐⭐⭐ YUK HUI POST-EUROPE REVIEW IN STASIS — confirms Hui discussion cross-venue at Stasis + Logos",
                          "Natalia Stolbova — Искусство маленькой жизни",
                          "Georgy Layus — Парфянский выстрел Декарта, или о возможности эсхатологии в прямом смысле слова",
                          "Nikita Yatsenko — What's Up, New Dog? — CROSS-VENUE: Yatsenko also published in НЛО 191/2025 «Чрезвычайное положение после Идиллии» (Agamben-direct)"]}},
                 quote="Per https://stasisjournal.net/index.php/journal/issue/current — Vol 13 №2 published 2025-12-28"),
            claim("homepage", "through_author_signal.Yatsenko",
                  ["2025 Stasis Vol 13 №2: «What's Up, New Dog?»",
                   "2025 НЛО 191 (1/2025): «Чрезвычайное положение после Идиллии» (Agamben-direct, state of exception)",
                   "Yatsenko = cross-venue through-author bridge Stasis ↔ НЛО"],
                  status="external_claim", confidence="high",
                  quote="Two confirmed publications in Mavrinsky-tribe top venues 2025"),
            claim("homepage", "through_author_signal.Liberman_Hui_review",
                  ["Samson Liberman 2025 Stasis Vol 13 №2 review of Yuk Hui's «Post-Europe»",
                   "CONFIRMS: Hui's work is reviewed AT Stasis (not just on Logos editorial council)",
                   "Cross-venue Hui-discussion implication: Mavrinsky article citing Hui is operationally welcome at both Stasis (review) + Logos (council)"],
                  status="external_claim", confidence="high",
                  quote="Stasis publishes Hui review = Hui is operationally in conversation at Stasis level"),
            claim("stasis_centre_page", "editorial_board_publications.Syutkin",
                  ["2019 Stasis: «Gilles Deleuze among the new materialists: materialist dialectic versus neovitalism» — 3 cit ⭐⭐⭐ DELEUZE DIRECT",
                   "2024 Logos (with Serebryakov): «The fissure in the Absolute. A debate over utopia in critical theory» — 4 cit ⭐ CROSS-VENUE Logos publication",
                   "2025 Stasis Vol 13 №2: «Шеллинг и материалистическая теодицея» (response to Chepurin)",
                   "2025 Stasis: «Как Абсолют становится слабым: современная материалистическая диалектика и проблема теологии»",
                   "Stasis Centre faculty + Senior Lecturer",
                   "specialization: Deleuze + materialist dialectics + Schelling + post-Marxism + Hegelian theology",
                   "CROSS-VENUE confirmed: Syutkin is Stasis Centre faculty AND Logos author 2024"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar 2026-06-14 — Syutkin = new bridge node Stasis Centre ↔ Logos"),
            claim("motto_distribution", "editorial_board_publications.Magun_2024_book",
                  ["2024 book: «The Temptation of Non-being: Negativity in Aesthetics»",
                   "Continues «Энциклопедия диалектических наук» negative-aesthetics series",
                   "Reinforces dialectics encyclopedia ongoing project + EUSP-publishing",
                   "Counterpart to «Искус небытия» 2020 Vol 1 + «От триггера к трикстеру» 2023 Vol 2"],
                  status="external_claim", confidence="high",
                  quote="Books.google.com 2024 entry"),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("editorial_council_board", "editorial_board_publications.Khrenov",
                  ["Doctor of Philosophy, Moscow State Institute of Art Studies",
                   "2017: «Средства массовой коммуникации в ракурсе виртуальной реальности» — 9 cit MOST-CITED",
                   "2025 Filological Vestnik Verkhnevolzhski: «Theory and History of Culture and the Arts»",
                   "2022 Sphere of Culture: «A Conversation about the Meanings and Mission of Culture at the Time of Social Turbulence» (with Ionesov) — 1 cit",
                   "2015 VGIK Journal: «Eisenstein's Aesthetics in Semiotic Perspective»",
                   "2014 VGIK: «From Demonism to Political Catastrophes — Notes on Sokurov's «Faust»»",
                   "2021 same series: «Art History and Cultural Studies»",
                   "Cited 2026 Man and Culture via cultural-historical approach Philippe Ariès + Olga Kirillova",
                   "Council Chair Артикульт",
                   "specialization: culturology + arts theory + Eisenstein + film theory + virtual reality + cultural anthropology"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar 2026-06-14"),
        ],
    ),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("eusp_journal_page", "editorial_board_publications.Kelly",
                  ["2012 book (with Bassin): «Soviet and post-Soviet identities» — 139 CIT MOST-CITED",
                   "2021 book: «Soviet Art House: Lenfilm Studio under Brezhnev» — 23 cit",
                   "2024 Wiley Russian Review: «The Motherland and the Fight with Fascism: War Cult and War Film under Brezhnev» — 4 cit",
                   "2024 Oxford UP Forum for Modern Language Studies: «Imperial Transnationality: On Soviet Screens» — 1 cit",
                   "2025 Slavonic and East European Review: review of «Stalin's Final Films»",
                   "2025 Taylor & Francis Studies in Russian and Soviet Cinema: «Mentoring and the national cinema: Andrei Tarkovsky's letters to Bagrat Hovhannisyan»",
                   "2021 Slavonic and East European Review: «Beyond Censorship: Goskino USSR and the Management of Soviet Film, 1963–1985» — 2 cit",
                   "2013 Journal of Modern History: «What Was Soviet Studies and What Came Next?» — 15 cit",
                   "2002 Kritika: «Ordinary life in extraordinary times» — 21 cit (Foucault material culture cited)",
                   "Trinity College Cambridge senior research fellow",
                   "Professor of Russian Oxford",
                   "specialization: Russian/Soviet cinema + cultural history + Soviet visual culture; T&F + Wiley + Cambridge + Oxford UP publishing"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar 2026-06-14"),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("editorial_team", "editorial_board_publications.Spiridonov",
                  ["2019 Frontiers in Psychology: «The role of motor activity in insight problem solving (nine-dot problem)» (with Loginov, Ivanchei) — 27 cit MOST-CITED",
                   "2023 Психология ВШЭ: «Embodied Problem Solving: A Review of Experimental Paradigms» (with Loginov) — 1 cit",
                   "2025 Wiley Journal of Creative Behavior: «Is the Aha! Experience a Holistic Construct?» (with Savinova) — 3 cit",
                   "2025 Frontiers in Psychology: «The modulating role of sources of difficulty in interactive matchstick algebra» (with Klowait, Erofeeva) — 1 cit",
                   "2025 Психология ВШЭ: «Mental Models in Action» (with Loginov, Ammalainen)",
                   "2019 SSRN: «Конспирологическая картина мира»",
                   "2017 RJCS: «Priming and Set in Problem Solving» — 1 cit",
                   "2013 Psychology HSE: «New Methods for Thinking Process Research» — 3 cit",
                   "Department of Psychology RANEPA",
                   "specialization: cognitive psychology + problem-solving + insight + embodied cognition + Aha! experience"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar 2026-06-14 — confirms cross-venue between Шаги and Артикульт council"),
        ],
    ),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("editorial_team", "through_author_signal.Khestanov",
                  ["2022 Городские исследования и практики (Urban Studies = this venue): «Кто принимает решения в умном городе» (with Suvalko) — 6 cit",
                   "CROSS-VENUE confirmed: Khestanov on Logos+Соц.обозр boards + author in Anashvili-edited Urban Studies",
                   "Mavrinsky-adjacent: smart city governmentality + emotional-aesthetic dimension"],
                  status="external_claim", confidence="high",
                  quote="Confirmed cross-venue triangulation: Khestanov Urban Studies + Логос + Соц.обозр"),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("iculture_homepage", "editorial_board_publications.Sokolov",
                  ["2004 monograph: «Генезис истории» — 58 citations MOST-CITED",
                   "2024 Vestnik SPbU Filosofiya и Konfliktologiya 34(3): «Post-, trans-, hyper-sin» (Kierkegaard + religious philosophy)",
                   "2019 Observatory of Culture vol 16 №5: «Clustering of Cultural Reality Topoi» (with Alekseev-Apraksin) — 7 cit",
                   "2025 Studia Culturae: «Beyond Barthes: analysing texts of various forms and genres» (with student team)",
                   "Book chapter: «Движение против (Кьеркегор, Шестов)»",
                   "Doctoral thesis: «Мифологические истоки китайской трагедии. Культур-философский анализ»",
                   "2017 (with Larionov): «Мыслить (со)временность. Блок Z: зона сознания» — 9 cit",
                   "Vlasova 2012 «Феноменологическая психиатрия и экзистенциальный анализ» (184 cit) cites Sokolov's culturological approach to history of philosophy",
                   "specialization: Kierkegaard + Shestov existentialism + history of culture (Genesis of history) + cultural reality clustering"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar B.G. Sokolov SPbU"),
        ],
    ),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("editorial_team", "editorial_board_publications.Bankovskaya",
                  ["2014 Соц.обозр: «Living in-between: The uses of marginality in sociological theory» — 27 cit MOST-CITED",
                   "2014 Соц.обозр Russian: «Между границ: понятие маргинальности в социологической теории» — 1 cit",
                   "«Чужак на фронтире» — HSE publications (Schuetz citation)",
                   "Korbut 2014 European Journal of Social Theory (36 cit) thanks Bankovskaya «for being a pilot in the ocean of sociological theory»",
                   "specialization: marginality, frontier, Schutz phenomenological sociology, sociology of culture borders"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar 2026-06-14"),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("chelovek_board_inference", "editorial_board_publications.Avanesov",
                  ["2018 Praxema: «Городское пространство как антропологический феномен» — 58 cit MOST-CITED",
                   "2016 Praxema: «Визуальная семиотика города: перспектива исследования городских текстов» — 41 cit",
                   "2016 Praxema: «Сакральная топика русского города (2). Софийский собор» — 7 cit",
                   "2023 Praxema: «Визуальные паттерны городской среды и локальная идентичность» — 8 cit",
                   "2024 Urbis et Orbis: «Городской вид как культурная ценность» — 2 cit",
                   "2022 Slovo.ru: «Визуальный текст средневекового Владимира»",
                   "2022 Visual Theology: «Сакральная топика русского города (11): визуализация сакрально-политической темы»",
                   "2022 Urbis et Orbis: «Город: кинороли» — 3 cit",
                   "2024: «Культурный код города»",
                   "2015 Praxema: «Быть человеком и быть видимым» — 2 cit",
                   "2014 Идеи и идеалы: «Визуально-практически е аспекты языковой коммуникации» — 3 cit",
                   "specialization: city-semiotics, philosophical anthropology, sacral topography, urban visual ecology"],
                  status="external_claim", confidence="high",
                  quote="Google Scholar Avanesov S.S. via Praxema corpus"),
            claim("issue_2024_2", "through_author_signal.Markov",
                  ["2025 Praxema №1: «Семиотика буквы в современном искусстве: шрифтовой биохакинг Одеда Эзера» (with Sosnovskaya) — 1 cit",
                   "2025 Вестник РХГА: «ЭРМИТАЖ КАК ИНТЕРФЕЙС ОБЪЕКТА НАЦИОНАЛЬНАЯ ИДЕНТИЧНОСТЬ» (with Sosnovskaya) — INTERFACE-DIRECT Mavrinsky vocabulary",
                   "2023 Praxema: «СЕМИОТИЧЕСКИЙ ИНСТРУМЕНТАРИЙ ЛЕКЦИИ ПО ВИЗУАЛЬНОЙ ФИЛОСОФИИ: МЕХАНИЧЕСКАЯ УТКА ДЕКАРТА» (with Shtayn) — 1 cit",
                   "2023 Praxema: «ACTING PERFORMANCES IN UZBEK DOCUMENTARY FILMS» (with Ismailov)",
                   "2022 Praxema: «ИКОНОЛОГИЯ ИЗОБРАЗИТЕЛЬНЫХ ЭЛЕМЕНТОВ СТИХОТВОРЕНИЙ КНЯЗЯ ВЛАДИМИРА ПАЛЕЯ»",
                   "2025 Praxema №3: latest Markov+Sosnovskaya paper",
                   "2025 Corpus Mundi: «The Ontology of the Body-Mediator: From Bakhtinian Polyphony to a Dictionary of Untranslatables» (with Shtayn)",
                   "CONFIRMS through-author bridge: Markov has 5+ Praxema papers across 2022-2025"],
                  status="external_claim", confidence="high",
                  quote="Markov A.V. is Артикульт Deputy Editor + 5+ Praxema publisher — strongest through-author bridge in pool"),
        ],
    ),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("redkollegiya", "editorial_board_publications.Pokrovsky",
                  ["2026 Вестник Института: «Постаграрность: альтернативная перспектива для сельских территорий Центральной России» (with Shilova)",
                   "Department of General Sociology HSE Editor",
                   "Chief Researcher Institute of Sociology RAS",
                   "Mass publication network (cited via Chuykova 2021 with Yefremenko, Simonova as co-editor in HSE General Sociology series)",
                   "specialization: rural sociology + post-agriculture + sociology of professions + sociological theory"],
                  status="external_claim", confidence="medium",
                  quote="Google Scholar 2026-06-14"),
        ],
    ),
    ...
    VenueDef(
        ...
        claims=[
            ...
            claim("iphras_listing", "aims_scope",
                  ...
                  status="official_claim", confidence="high"),
            claim("iphras_listing", "editorial_board_publications.Stolyarov",
                  ["2016: Translation of Gaius Musonius Rufus (Roman Stoic) — with Mikhailov+Fokin",
                   "Cited by Sanzhenakov 2015 + Korolkova 2025 + Korobeynikov 2026 + Pavlenko 2017 as defining Russian Stoicism literature",
                   "Author of widely-cited Stoicism reference work in Russian academic philosophy",
                   "specialization: Ancient Greek philosophy + Roman Stoicism + Western philosophy history; PhD Western Phil History Sector IF RAN",
                   "Key works on: aretology + axiology of Stoics, doctrine of natural law, Lekton problem"],
                  status="external_claim", confidence="high",
                  quote="Multiple secondary citations in Russian philosophical journals confirm canonical status"),
        ],
    ),
]
